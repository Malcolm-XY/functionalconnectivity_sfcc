...
# # %% validation 3; vc
# fcnetwork, feature, subject_range, experiment_range = 'vc', 'PCC', range(2, 6), range(1, 4)
...
# # %% validation 4; mx
# fcnetwork, feature, subject_range, experiment_range = 'mx', 'PCC', range(2, 6), range(1, 4)
