...
class CNN2DModel_3layers_adaptive_avgpool(nn.Module):
    def __init__(self, channels=3, num_classes=3):
        super(CNN2DModel_3layers_adaptive_avgpool, self).__init__()
...
class CNN2DModel_3layers_adaptive_maxpool(nn.Module):
    def __init__(self, channels=3, num_classes=3):
        super(CNN2DModel_3layers_adaptive_maxpool, self).__init__()
